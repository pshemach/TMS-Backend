...
def get_vehicle(id: int, db: Session = Depends(get_db)):
    ...
    """
    try:
        vehicle = fleet_operation.get_vehicle(id=id, db=db)
        return vehicle
    except HTTPException as e:
        raise e
    except Exception as e:
...
def create_vehicle(fleet_id: int, request: schemas.VehicleRequest, db: Session = Depends(get_db)):
    ...
    """
    try:
        new_vehicle = fleet_operation.create_vehicle(fleet_id=fleet_id, request=request, db=db)
        return new_vehicle
    except HTTPException as e:
        raise e
    except Exception as e:
...
def update_vehicle(id: int, request: schemas.VehicleRequest, db: Session = Depends(get_db)):
    ...
    """
    try:
        vehicle = fleet_operation.update_vehicle(vehicle_id=id, request=request, db=db)
        return vehicle
    except HTTPException as e:
        raise e
    except Exception as e:
...
def delete_vehicle(id: int, db: Session = Depends(get_db)):
    ...
    """
    try:
        msg = fleet_operation.delete_vehicle(vehicle_id=id, db=db)
        return msg
    except HTTPException as e:
        raise e
    except Exception as e:
